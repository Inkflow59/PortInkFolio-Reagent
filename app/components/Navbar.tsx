...
const Navbar = () => {
  ...
  return (
    <div className={`fixed bottom-0 w-full flex items-center justify-between p-2 ${theme === 'dark' ? 'bg-gray-900/70 text-white border-t border-white/70' : 'bg-white text-gray-800 border-t border-black'}`}>
